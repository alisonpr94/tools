...
from .views import ToolListCreateView, ToolDeleteView, ToolRetrieveView, ToolListByTagView, ToolRetrieveUpdateView
...
urlpatterns = [
    ...
    path('tools/<int:pk>/update/', ToolRetrieveUpdateView.as_view(), name='tool-update'),
]